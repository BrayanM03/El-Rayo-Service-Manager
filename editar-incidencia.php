...
<head>
    ...
    <title>Editar incidencia | El Rayo Service Manager</title>
...
<body id="page-top">
                    ...
                    <div class="card">
                        ...
                        <div class="row m-3">
                            ...
                            <div class="col-12 col-md-3">
                                ...
                                <select class="form-control selectpicker" id="tipo">
                                    ...
                                    <option value="0">Percepcion</option>
                                </select>
                            </div>
                        ...
                        <div class="row m-3">
                            ...
                            <div class="col-12 col-md-3">
                                ...
                                <select class="form-control selectpicker"  onchange="aplicarCambiosExtras(event)" id="periocidad">
                        ...
                        <div class="row m-3">
                            ...
                            <a href="incidencias.php"><div class="btn btn-info">Volver</div></a>
                                <div class="ml-2 btn btn-primary" onclick="actualizarIncidencia(<?= $_GET['id_incidencia']; ?>)">Actualizar</div>
                            </div>
    ...
    <script>
        ...
        //código a ejecutar
        setearDatosIncidencia(<?= $_GET['id_incidencia']; ?> );
        };
    </script>
