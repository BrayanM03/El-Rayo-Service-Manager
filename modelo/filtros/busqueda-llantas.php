...
if (isset($_GET['query'])) {
    ...
    $query = "SELECT id, Descripcion as descripcion, Marca as marca
              FROM llantas
    ...
    if ($result->num_rows > 0) {
        ...
        responder(true, 'Llantas encontrados', 'success', $clientes, true, true);
    } else {
        responder(false, 'No se encontraron llantas', 'warning', [], true, true);
    }
