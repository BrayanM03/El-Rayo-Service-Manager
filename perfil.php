...
<head> 
    ...
    <title>Perfil | El Rayo Service Manager</title>
...
<?php include 'views/loader.php'; ?>
    ...
    <div id="wrapper">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content" sucursal_session_id= "<?php echo $_SESSION['id_sucursal']; ?>" rol_session_id="<?php echo $_SESSION['rol']?>">
              ...
              <?php 
                $disabled_sucursal = $_SESSION['rol']==1 ? '' : 'disabled';
              ?>
                <!-- Begin Page Content -->
                <div class="container-fluid" style="height: 100%; padding-top:8%">
                       <div class="card card_usuario">
                            <div class="card-header" style="background-color: white;">Pefil de usuario</div>
                            <div class="row mt-4 justify-content-center">
                                <div class="col-10">
                                    <img src="./src/img/neumaticos/NA.JPG" id="perfil" alt="" style="width: 9rem; border:1px whitesmoke solid; border-radius:7px">
                                    <div class="btn btn-sm btn-primary" style="margin-top: 5.5rem; margin-left:.7rem">Cambiar foto</div>
                                </div>
                            </div>
                            <div class="row mt-3 justify-content-center">
                                <div class="col-4">
                                    <label for=""><b>Nombre</b></label>
                                    <input type="text" class="form-control" id="nombre"  value="<?= $_SESSION['nombre']?>" placeholder="Nombre">
                                </div>
                                <div class="col-6">
                                    <label for=""><b>Apellidos</b></label>
                                    <input type="text" class="form-control" id="apellidos" value="<?= $_SESSION['apellidos']?>"  placeholder="Apellidos">
                                </div>
                                <div class="col-5 mt-3">
                                    <label for=""><b>Sucursal</b></label>
                                    <select class="form-control" id="sucursal" <?= $disabled_sucursal?>>
                                        <?php
                                                ...
                                                if($total_s > 0){
                                                    ...
                                                    while ($data = $resultado->fetch_assoc()) {
                                                        $selected = $data['id'] == $_SESSION['id_sucursal'] ? 'selected': '';
                                ...
                                <div class="col-5 mt-3">
                                    ...
                                    <input type="text" class="form-control" id="puesto" placeholder="Ejemp. ingeniero">
                                </div>
                            </div>
                            <div class="row text-start mt-4 justify-content-center">
                                <div class="col-5">
                                    <label><b>Telefono</b></label>
                                   <input type="text" class="form-control" id="telefono" placeholder="+52 83 4268 2283">
                                </div> 
                                <div class="col-5">
                                    <label><b>Correo</b></label>
                                   <input type="email" class="form-control" id="correo" placeholder="alguien@empresa.com">
                                </div> 
                            ...
                            <div class="row text-start mt-4 justify-content-center">
                                <div class="col-5">
                                    ...
                                    <input type="date" class="form-control" id="fecha-cumple">
                                    </div>
                                </div> 
                                <div class="col-5">
                                    <div>
  ...
  <!-- Footer -->
    ...
    <script src="src/js/perfil.js?v=<?php echo(rand()); ?>"></script>
