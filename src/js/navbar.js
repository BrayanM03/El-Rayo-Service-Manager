...
function corteNavBar(){
    Swal.fire({
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-12 col-12">
                        ...
                        <label for="sucursal-navbar">Selecciona una sucursal</label>
                        <select class="form-control" id="sucursal-navbar">
        ...
        id_sucursal = $("#sucursal-navbar").val();
        if(id_sucursal == "all"){
    ...
    Swal.fire({
        ...
        html: `
            <div class="container">
                <div class="row">
                    <div class="col-md-12 col-12">
                        <label for="sucursal-nav">Selecciona una sucursal</label>
                        <select class="form-control" id="sucursal-nav"></select>
                    </div>
                </div>
                <div class="row mt-2">
                    <div class="col-md-12 col-12">
    ...
    Swal.fire({
        ...
        html: `
            <div class="container">
                ...
                <div class="row mt-2">
                    <div class="col-md-12 col-12">
                        <label for="year-comision">Año</label>
                        <select class="form-control" id="year-comision">
                            <option value="2023">2023</option>
                        </select>
                    </div>
