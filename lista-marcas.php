...
<head> 
    ...
    <title>Lista de marcas | El rayo service manager</title>
...
<body id="page-top"> 
            ...
            <div id="content">
                ...
                <div class="containe" style="width:80%; margin:auto;"> 
                     ...
                     <div class="titulo-inventario m-auto">
                         <h5 style="margin: 10px 0px;">Marcas manejadas</h5>
                         <p style="color: gray;">Lista de marcas manejadas, para agregar una nueva presiona "Agregar marca".</p>
                        </div>
                        
                      <div class="botones">
                                    <a href="agregar-marca.php" class="btn btn-success btn-icon-split">
                      ...
                      <div class="row justify-content-center">
                            <div class="col-12 col-md-8">
                                ...
                                <table id="lista-marcas"  class="table table-bordered table-hover">  
                                    <thead>
                                        <tr>
                                            <td>#</td>
                                            <td>Nombre</td>
  ...
  <script src="https://nightly.datatables.net/colreorder/js/dataTables.colReorder.min.js"></script>
    ...
    <script src="src/js/lista-marcas.js"></script>
