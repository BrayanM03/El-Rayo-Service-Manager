...
<head>
    ...
    <title>Usuarios | El Rayo Service Manager</title>
                    ...
                    <div class="mt-3" style="width:90%; margin:auto;">
                        ...
                        <div class="row">
                            <div class="col-md-10">
                                ...
                                <span>Esta es la lista de usuarios registrados para el uso del sistema</span>
                            </div>
                            <div class="col-md-2 text-right">
                                <a class="btn btn-info mt-4" href="nuevo-empleado.php">Agregar usuario</a>
                            </div>
                        </div>
                        <hr>
                        </div>
                        ...
                        <table id="usuarios" class="table table-stripe table-hover">
                        </table>
