...
<body id="page-top">
            ...
            <div id="content">
                ...
                <div class="containe" style="width:80%; margin:auto;">
                    ...
                    <div class="titulo-inventario m-auto">
                        <h5 style="margin: 10px 0px;">Promociones</h5>
                        <p style="color: gray;" class="text-center">Las promociones aplican para todas la sucursales</p>
                    </div>

                    <div class="row mb-3 mt-3">
                        <div class="col-5">
                            <div class="form-group">
                                <label for="busquedaLlantas">Buscar llanta del catalogo</label>
                        ...
                        <div class="col-4 col-md-2">
                            <div class="form-group">
                                ...
                                <input type="number" class="form-control" id="precio_promocion" placeholder="0.00">
                            </div>
                        </div>
                        <div class="col-4 col-md-2">
                            <div class="form-group">
                                <label>&nbsp;</label><br>
                                <div class="btn btn-primary" id="btn-promocion" onclick="agregarPromocion()"><span>Agregar promoción</span></div>
                            </div>
                        </div>
                    </div>
 ...
 -->
        ...
        <script src="src/js/promociones.js"></script>
