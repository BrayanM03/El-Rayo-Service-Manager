...
require_once 'modelo/empleados/Empleado.php';
$empleado= new Empleado($con);
$response = $empleado->obtenerDatosEmpleado($_GET['id']);
if(!$response['estatus']){
    $activar_swal = 1;
    $emp= [];
}else{
...
<head>
    ...
    <title>Editar empleado | El Rayo Service Manager</title>
...
<body id="page-top">
                            ...
                            <div class="row justify-content-between">
                                ...
                                <div class="col-6 text-right">
                                    <nav class="breadcrumbs">
                                        <div id="bread_paso_1" style="cursor: pointer;" class="breadcrumbs__item is-active">Datos generales</div>
                                        <div id="bread_paso_2" style="cursor: pointer;"  onclick="cargarHorario()" class="breadcrumbs__item">Horario</div>
                                        <div id="bread_paso_3" style="cursor: pointer;" onclick=" mostrarDocumentosEmpleado()" class="breadcrumbs__item">Datos adjuntos</div>
                                    </nav>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="card-body" id="card-body" style="background-color: white;">
                            <div class="row mt-4 justify-content-center">
                                ...
                                <div id="area-canvas" class="col-md-2 col-12">
                                    <?php if($emp['foto_perfil']==1){
                                        ?>
                                        <span aria-hidden="true" class="btn-x-documento" onclick="deleteThumb()">×</span>
                                    <?php
                                    }?>
                                    <img src="./src/img/fotos_empleados/E<?= $emp['id'] . '.' . $emp['extension'] ?>?v=<?php echo (rand()); ?>"  onerror="this.src='./src/img/neumaticos/NA.JPG'" alt="" style="width: 9rem; border:1px whitesmoke solid; border-radius:7px">
                                ...
                                <div class="col-md-2 col-12">
                                        <label for="genero"><b>Estatus del empleado</b></label>
                                        <select class="form-control selectpicker form-control-sm" id="estatus">
                            ...
                            <div class="row mt-3 justify-content-center">
                                <div class="col-3">
                                    ...
                                    <input value="<?= $emp['nombre'];?>" type="text" class="form-field form-control-sm" id="nombre" placeholder="Nombre">
                                    <small style="color:red" class="d-none" id="nombre-adv">Ingresa nombre del empleado</small>
                                </div>
                                <div class="col-4">
                                    <label for="apellidos"><b>Apellidos</b></label>
                                    <input value="<?= $emp['apellidos'];?>" type="text" class="form-field form-control-sm" id="apellidos" placeholder="Apellidos">
                                    <small style="color:red" class="d-none" id="apellidos-adv">Ingresa apellidos del empleado</small>
                                </div>
                                <div class="col-3">
                                    <label for="rfc"><b>RFC</b></label>
                                    <input value="<?= $emp['rfc'];?>" type="text" class="form-field form-control-sm" id="rfc" placeholder="RFC">
                                </div>
                                ...
                                <div class="col-3 mt-3">
                                    <div>
                                        ...
                                        <input value="<?= floatval($emp['salario_base']);?>" type="number" class="form-field form-control-sm" id="salario-base" placeholder="0.00">
                            ...
                            <div class="row text-start mt-4 justify-content-center">
                                <div class="col-4">
                                    ...
                                    <input value="<?= $emp['telefono'];?>" type="text" class="form-field form-control-sm" id="telefono" placeholder="+52 83 4268 2283">
                                </div>
                                <div class="col-3">
                                    <label for="correo"><b>Correo</b></label>
                                    <input value="<?= $emp['correo'];?>" type="email" class="form-field form-control-sm" id="correo" placeholder="alguien@empresa.com">
                                </div>
                                <div class="col-3">
                                    <div>
                            ...
                            <div class="row text-start mt-4 justify-content-center">
                                <div class="col-3">
                                    <div>
                                        ...
                                        <input value="<?= $emp['fecha_nacimiento'];?>" type="date" class="form-field form-control-sm" id="fecha-cumple">
                                    </div>
                                </div>
                                <div class="col-3">
                                    <div>
                                        <label for="fecha-ingreso"><b>Fecha ingreso</b></label>
                                        <input value="<?= $emp['fecha_ingreso'];?>" type="date" class="form-field form-control-sm" id="fecha-ingreso">
                                    </div>
                                </div>
                                <div class="col-4">
                                    <div>
                            ...
                            <div class="row text-start mt-4 justify-content-center">
                                <div class="col-10">
                                    <div>
                                        ...
                                        <textarea class="form-field form-control-md" id="direccion" placeholder="Escribe la dirección del empleado"><?= $emp['direccion'];?></textarea>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row text-center mt-4 justify-content-center">
                                <div class="col-4">
                                    <div class="btn btn-info" onclick="guardarDatosGenerales(<?=$_GET['id']?>)">Guardar datos generales</div>
                                </div>
                            </div>
    ...
    <script src="src/js/empleados/editar-empleado.js?v=<?php echo (rand()); ?>"></script>
<!--     <script src="src/js/empleados/nuevo-empleado.js?v=<?php echo (rand()); ?>"></script> -->

    <script>

        let activar_swal_error = <?= $activar_swal ?>;
        if(activar_swal_error==1){
        ...
        $("#sucursal").val(<?= $emp['id_sucursal']?>)
        $("#puesto").val(<?= $emp['id_puesto']?>)
        $("#genero").val(<?= $emp['genero']?>)
        $("#usuario").val(<?= $emp['id_sucursal']?>)
        $("#estatus").val(<?= $emp['estatus']?>)
