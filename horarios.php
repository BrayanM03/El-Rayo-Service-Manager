...
<head>
    ...
    <title>Horarios | El Rayo Service Manager</title>
    ...
    <link href="src/css/horarios.css" rel="stylesheet">
...
<body id="page-top">
            ...
            <div id="content">
                ...
                <!-- Begin Page Content -->
                    <div class="mt-3" style="width:90%; margin:auto;">
                        ...
                        <div class="row">
                            <div class="col-md-10">
                                <h3><b>Lista de horarios</b></h3>
                                <span>Esta es la lista de horarios registrados.</span>
                            </div>
                            <div class="col-md-2 text-right">
                                <div class="btn btn-info mt-4" onclick="armarHorario()">Agregar horario</div>
                            </div>
                        </div>
                        <hr>
                        </div>
                        ...
                        <table id="horarios" class="table table-stripe table-hover">
                        </table>
    ...
    <!-- Page level plugins -->
    <script src="src/js/horarios.js"></script>
