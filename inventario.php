                ...
                <div class="containe" style="width:80%; margin:auto;"> 
                     ...
                     <div class="titulo-inventario m-auto">
                      ...
                      <div class="botones">
                                    ...
                                    <a href="ingresar-mercancia.php?nav=0&sucursal_id=<?php echo $_GET['id']; ?>" class="btn btn-success btn-icon-split <?php if($_SESSION['rol'] !=2 && $_SESSION['rol']!=1 && $_SESSION['rol']!=4){ echo 'd-none';} ?>">
                                        <span class="icon text-white-50">
                                            <i class="fas fa-check-circle"></i>
                                        </span>
